...
| G6 | N=6, B=0, R=5, P5=−8.0, FRESH=30h | bear/down/False | `pass` | **0.40** | base 0.50 − D1(신선도 30h) 0.10 = 0.40. 감점 직전 대비: FRESH=24.0h였다면 0.50 |

> ⚠️ 개정 이력 v0.1.1 (2026-07-14): G6 입력 B=1→0 수정. B=1이면 D2(반대의견 감점)도 발동해 0.30이 되므로, D1 단독 검증 의도와 어긋났음 — **구현+회귀테스트가 스펙 모순을 검출**한 사례.
