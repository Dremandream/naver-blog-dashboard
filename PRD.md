...
_최종 갱신: 2026-07-11 (세션 9)_

---

## 1. 목적 (Why)
투자 블로거·텔레그램 채널 다수를 매일 자동 수집·요약·비교하여, **사용자가 15개 소스를 직접 읽지 않고도 하루 시장 시각을 파악**하게 한다. 목표는 **리서치 시간 단축**이지, 매매 판단 대체가 아니다.
...
## 5. 소스 (현재 15개)
- 블로그 10: config/blogs.json
- 텔레그램 5: config/telegram-channels.json (공개 채널만, t.me/s/ 스크래핑)
- **적정 범위 15~20개.** 25개 초과 시 generateDailyBrief max_tokens 상향 + SpikeAlert/WeeklyTrend 임계값 튜닝 필요.
