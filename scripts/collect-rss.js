...
반드시 아래 JSON만 출력하세요 (마크다운 없이):
{
  "headline": "오늘의 핵심 한 줄 (예: '반도체 강세론 우세 속, 수급 괴리 경고한 소수의견 존재')",
  "brief": "필자들의 시각을 비교하는 종합 4~6문장. 누가 어떤 근거로 무엇을 보는지 구체적으로. 수치 포함.",
  "consensus": ["다수가 공통으로 보는 시각 — 이미 반영됐을 가능성 (없으면 빈 배열)"],
  "divergence": ["의견이 정면으로 갈리는 지점 (없으면 빈 배열)"],
  "minority": ["소수·역발상 의견 — 다수와 다른 근거 있는 시각이나 남들이 놓친 관점. 누가 왜 그렇게 보는지 근거까지. (진짜 없으면 빈 배열)"],
