...
- **미결/제안(사용자 검토 요청)**: ⓑ랭킹 신뢰용 MIN_SAMPLE 5→20~30? 1년에 n=12~32 소수 소스가 상위 정렬됨(금싸 n=12) — 미적용. ⓒ history 17.5MB 여전히 큼 → 종가를 "필요 셀만"(의견일+평가시점) 남기는 정밀 트림하면 대폭 감소 가능하나 위험/복잡 — 미적용.
